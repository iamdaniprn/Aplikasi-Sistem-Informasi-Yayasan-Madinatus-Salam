    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Identitas Ibu</h1>
                </div>
                <!--End Page Header -->
            </div>
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                ...
                                <?php
                                    Include('koneksi.php');
                                    $user=$_GET['id'];
                                    $sql=mysql_query("select * from identitas_ibu where id_santri='$user'");
                                    while($row=mysql_fetch_array($sql)){
                                ?>
                                    <form enctype="multipart/form-data" action="upload_identitas_ibu.php" method="post">
                                    ...
                                    <table class="table table-sm">
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>:</td>
                                          <td><input type="text" name="nama_ibu" size="70" class="form-control" value="<?php echo $row['nama_ibu']?>"></td>
                                        </tr>
                                        <tr>
