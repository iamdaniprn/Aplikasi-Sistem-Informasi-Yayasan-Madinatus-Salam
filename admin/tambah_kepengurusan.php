                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <div class="col-md-8">
                                    <form enctype="multipart/form-data" action="upload_susunan.php" method="post">
                                    <div class="form-group">
                                        <label class="control-label col-sm-4">Nama Pengurus </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4">Masukkan Foto </label>
                                        <div class="col-sm-8">
