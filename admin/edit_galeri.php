                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                ...
                                <?php
                                    Include('koneksi.php');
                                    $id=$_GET['id'];
                                    $sql=mysql_query("select * from galeri where id_gambar='$id'");
                                    while($row=mysql_fetch_array($sql)){
                                ?>
                                    <form enctype="multipart/form-data" action="proses_edit_galeri.php" method="post">
                                    <div class="form-group">
                                        <input type="hidden" name="id" size="120" value="<?php echo $row['id_gambar']?>" />
                                    </div> 
                                    <div class="form-group">
