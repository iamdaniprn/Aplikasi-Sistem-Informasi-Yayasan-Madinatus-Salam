                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                    <form enctype="multipart/form-data" action="proses_edit_artikel.php" method="post">
                                    <div class="form-group">
                                        <input type="hidden" name="id" size="150" class="form-control" value="<?php echo $row['id_artikel']?>" />
                                    </div> 
                                    <div class="form-group">
                                        <label>Judul</label>
                                        <input type="text" name="judul" size="120" class="form-control" value="<?php echo $row['judul']?>" />
                                    </div> 
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="ckeditor1" name="des" class="form-control" value="<?php echo $row['des']?>"></textarea>
                                    </div>                                          
