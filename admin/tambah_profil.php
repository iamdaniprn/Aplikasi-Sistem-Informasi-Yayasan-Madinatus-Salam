    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Profil Yayasan</h1>
                </div>
                <!--End Page Header -->
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <form enctype="multipart/form-data" action="upload_profil.php" method="post">
                                    <div class="form-group">
                                        <label>Nama Profil</label>
                                        <input type="text" class="form-control" name="nama_profil" size="120" />
                                    </div> 
                                    <div class="form-group">
                                        <label>Foto Profil <i>jika ada</i></label>
                                        <input type="file" name="gambar" />
                                    </div> 
                                    <div class="form-group">
                                        <label>Isi</label>
                                         <textarea name="isi" id="ckeditor1" class="form-control"></textarea>
                                    </div>                                         
