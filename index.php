    ...
    <div class="section" style="background:#fff;">
      <div class="container">
        ...
        <div class="big-title text-center" data-animation="fadeInDown" data-animation-delay="01">
          <h1>Selamat Datang di Website Resmi<strong> Yayasan Madinatus Salam</strong></h1>
        </div>
        <!-- End Big Heading -->

        <!-- Some Text -->
        <p class="text-center">Mari Bersama Kami Menggapai Indahnya Cahaya Al-Qur'an</p>
      </div>
    </div>
 ...
 <!-- Start Testimonials Section -->
            ...
            <div class="custom-carousel show-one-slide touch-carousel" data-appeared-items="1">
              ...
              <div class="classic-testimonials item">
                <div class="testimonial-content">
                  <p>Selamat datang di Website Resmi Yayasan Madinatusalam, semoga dengan adanya website ini, kita bisa mempererat tali silaturahmi</p>
                </div>
                <div class="testimonial-author"><span>Nase Saepudin Zuhri, S.Ag.</span> - Ketua Yayasan</div>
              </div>
            </div>
    ...
    <div class=" section pricing-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="big-title text-center">
              <h1>Lihat <strong>Program</strong> Kami</h1>
            </div>
        </div>
        ...
        <?php 
            include("koneksi.php");
            $sql=mysql_query("select * from program") or die(mysql_error());
            while($row=mysql_fetch_array($sql))
            {
              $id=($row['id_program']);
              ?>
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="pricing-table">
                <div class="plan-name" style="background: silver">
                  <h3><?php echo $row['nama_program']?></h3>
                </div>
                <div class="plan-signup">
                  <?php
                      echo"<a class='btn-system btn-small' href='detail_program.php?id=$id'> Lihat Detail</a>";
                  ?>
                </div>
              </div>
            </div>
