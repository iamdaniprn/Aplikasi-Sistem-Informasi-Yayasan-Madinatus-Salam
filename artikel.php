  ...
  <div id="container">
    ...
    <div class="section" style="background:#fff;">
        ...
        <!-- Start Recent Posts Carousel -->
          <div class="latest-posts">
            ...
            <div class="latest-posts-classic" data-appeared-items="2">
                <?php 
                  include("koneksi.php");
                  $sql=mysql_query("select * from artikel order by id_artikel DESC limit 10") or die(mysql_error());
                  ...
                  <div class="post-row item">
                    ...
                    <div class="post-content">
                      <p><?php echo substr($row['des'],0,400)?> <a class="read-more" href="detail_artikel.php?id=<?php echo $id ?>"
                      >Read More...</a></p>
                    </div>
                  </div>
                 <?php }?>
      ...
      <!-- End Recent Posts Carousel -->
          ...
          <!-- Start Recent Posts Carousel -->
          <div class="latest-posts">
            <h4 class="classic-title"><span>Daftar Artikel</span></h4>
            <div class="latest-posts-classic" data-appeared-items="2">
                <?php 
                  include("koneksi.php");
                  ...
                  <div class="post-row item">
                    ...
                    <div class="post-content">
                      <p>
                          <?php echo "<img src='admin/artikel/.$row[2]' class='img-responsive' alt='portfolio img 1' width='100' height='100'><br>"; ?>
                          <a class="read-more" href="detail_artikel.php?id=<?php echo $id ?>">Read More...</a>
                      </p>
                    </div>
                  </div>
                 <?php }?>
