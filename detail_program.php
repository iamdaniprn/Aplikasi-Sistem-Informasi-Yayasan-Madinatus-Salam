    ...
    <div class="section" style="background:#fff;">
      <div class="container">
       ...
       <?php 
          include("koneksi.php");
          $id=$_GET['id'];
          $sql=mysql_query("select * from program where id_program=$id") or die(mysql_error());
          ...
          ?>
            ...
            <div class="latest-posts">
              <h4 class="classic-title"><span>Program Kami</span></h4>
            </div>
            <div class="left-meta-post">
                ...
                <!-- Some Text -->
            <div>
              <?php echo "<img src='admin/galeri/.$row[3]' class='img-responsive' alt='portfolio img 1' width='300' height='300'><br>"; ?>
            </div>
